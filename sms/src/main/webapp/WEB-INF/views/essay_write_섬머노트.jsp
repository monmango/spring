							...
							<div class="row">
								<div class="col-md-7">
									<div class="form-group">
										<span>Subject</span> 
										<input class="input" type="text" name="essay_subject">
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
										<textarea class="input" id="summernote" name="essay_content" placeholder=""></textarea> 
										<script>
									...
									<input type="submit" class="v_btn" id="submit" value="Submit" />
									<input type="button" class="v_btn" id="list" value="List" />
