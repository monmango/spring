...
<div id="nav">
	...
	<div id="nav-fixed">
		<div class="container">
			<!-- logo -->
			<div class="nav-logo">
				<a href="home.do?${session.user_id}" class="logo"><img src="./img/logo.png"
					alt=""></a>
			</div>
			<!-- /logo -->
			...
			<!-- nav -->
					<ul class="nav-menu nav navbar-nav" style="margin-left: 300px">
						...
						<li class="cat-4"><a href="blog-post.do">콘텐츠</a></li>
							...
							<c:otherwise >
								<li><div class="nav-btns">
										<button class="aside-btn">
											<img id="header_profile_pic" src="/sms/temp/${userDTO.user_image}" style="width:40px; height:40px">
										</button>
									</div></li>
							</c:otherwise>
						</c:choose>
