			...
			<div class="row">
				<!-- Post content -->
					...
					<a href="#" style="display: inline-block; margin: auto;"> <img
						class="img-responsive" src="/sms/temp/${essayDto.essay_img }" alt="">
					</a>
				<div class="section-row sticky-container">
					<div class="main-post">
						<h3>에세이 제목: ${essayDto.essay_subject }</h3>
						<p>작성일 : ${essayDto.essay_date }</p>

						<div>내용: ${essayDto.essay_content }</div>
				...
				<div class="section-row text-center">
					<form class="frm" method="get">
						...
						<div class="essay-btn">
							<button class="essayBtn" id="d_btn">Delete</button>
							<button class="essayBtn" id="u_btn">Update</button>
							<button class="essayBtn" id="l_btn">List</button>
						</div>
					</form>
				</div>
				<!-- ad -->
					...
					<div class="post-comments">
						...
						<div class="media">
							...
							<div class="media-body">
								<div class="media-heading">
									<h4>John Doe</h4>
									<span class="time">March 27, 2018 at 8:00 am</span> <a href="#"
										class="reply">Reply</a>
								</div>
