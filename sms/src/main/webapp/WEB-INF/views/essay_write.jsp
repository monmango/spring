							...
							<div class="row">
								<div class="col-md-7">
									<div class="form-group">
										<span>Subject</span> 
										<input class="input" type="text" name="essay_subject" id="essay_subject">
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
										<span>Summary</span>
										<textarea class="input" id="essay_summary" name="essay_summary" placeholder=""></textarea>
									</div>
									
									<div>
										<input type="file" id="essay_img" name="filepath" />
									</div>

									<div class="form-group">
										<span>Content</span>
										<textarea class="input" id="essay_content" name="essay_content" placeholder=""></textarea>
									</div>
