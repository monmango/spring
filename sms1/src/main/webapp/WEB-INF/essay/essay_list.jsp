...
<body>
		...
		<h1>에세이</h1>
			<c:forEach items="${e_list }" var="dto">
				<div class="e_list">
					...
					<div class="content">
						<div class="con_t">
							<c:url var="path" value="essayView.es">
								<c:param name="currentPage" value="${pv.currentPage }" />
								<c:param name="essay_num" value="${dto.essay_num }" />
							</c:url>	
							<h2><a href="${path }">${dto.essay_subject }</a></h2>
						</div>
	...
	<div class="pagelist">
		...
		<c:forEach var="i" begin="${pv.startPage }" end="${pv.endPage }">
			...
			<span> 
			<c:url var="currPage" value="essaylist.es">
