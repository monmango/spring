							...
							<div class="row">
								<div class="col-md-7">
									<div class="form-group">
										<span>Subject</span> 
										<input class="w3-input" type="text" name="essay_subject" id="essay_subject" value="${essayDto.essay_subject}">
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
										<span>Summary</span>
										<textarea class="w3-input" rows="10" cols="50" id="essay_summary" name="essay_summary" placeholder="">${essayDto.essay_summary}</textarea>
									</div>
									
									<div>
										<img id="img" src="/sms/temp/${essayDto.essay_img }"/>
										<input type="file" id="essay_img" name="filepath"  value="${essayDto.essay_img }"/>
							
									</div>

									<div class="form-group">
										<span>Content</span>
										<textarea class="w3-input" rows="10" cols="50" id="essay_content" name="essay_content" placeholder="">${essayDto.essay_content}</textarea>
									</div>
